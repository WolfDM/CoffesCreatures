...
import net.mcreator.coffeescreatures.entity.CoffeeNPCEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class CoffeeNPCRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CoffeeNPCEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelCoffeeNPC(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("coffees_creatures:textures/coffeecola.png");
					}
				};
			});
		}
