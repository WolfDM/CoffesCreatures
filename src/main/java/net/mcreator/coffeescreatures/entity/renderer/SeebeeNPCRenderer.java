...
import net.mcreator.coffeescreatures.entity.SeebeeNPCEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class SeebeeNPCRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SeebeeNPCEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelCoffeeNPC(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("coffees_creatures:textures/seebeenanigins.png");
					}
				};
			});
		}
	...
	public static class ModelCoffeeNPC extends EntityModel<Entity> {
