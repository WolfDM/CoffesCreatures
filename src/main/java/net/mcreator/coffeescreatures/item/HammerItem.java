...
public class HammerItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:hammer")
	public static final Item block = null;
	public HammerItem(CoffeesCreaturesModElements instance) {
		super(instance, 29);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CoffeesCreaturesTabItemGroup.tab).maxDamage(100));
		}
