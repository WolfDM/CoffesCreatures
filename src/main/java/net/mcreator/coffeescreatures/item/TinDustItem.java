...
public class TinDustItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:tin_dust")
	public static final Item block = null;
	public TinDustItem(CoffeesCreaturesModElements instance) {
		super(instance, 36);
	}
