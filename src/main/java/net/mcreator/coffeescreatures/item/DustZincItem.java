...
public class DustZincItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:dust_zinc")
	public static final Item block = null;
	public DustZincItem(CoffeesCreaturesModElements instance) {
		super(instance, 47);
	}
