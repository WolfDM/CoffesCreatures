...
public class DustIronItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:dust_iron")
	public static final Item block = null;
	public DustIronItem(CoffeesCreaturesModElements instance) {
		super(instance, 55);
	}
