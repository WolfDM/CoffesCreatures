...
public class IngotZincItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:ingot_zinc")
	public static final Item block = null;
	public IngotZincItem(CoffeesCreaturesModElements instance) {
		super(instance, 44);
	}
