...
public class DustCopperItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:dust_copper")
	public static final Item block = null;
	public DustCopperItem(CoffeesCreaturesModElements instance) {
		super(instance, 31);
	}
