...
public class DustBrassItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:dust_brass")
	public static final Item block = null;
	public DustBrassItem(CoffeesCreaturesModElements instance) {
		super(instance, 42);
	}
