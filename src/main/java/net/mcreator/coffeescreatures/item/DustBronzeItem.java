...
public class DustBronzeItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:dust_bronze")
	public static final Item block = null;
	public DustBronzeItem(CoffeesCreaturesModElements instance) {
		super(instance, 76);
	}
