...
public class CoinSilverItem extends CoffeesCreaturesModElements.ModElement {
	@ObjectHolder("coffees_creatures:coin_silver")
	public static final Item block = null;
	public CoinSilverItem(CoffeesCreaturesModElements instance) {
		super(instance, 11);
	}
